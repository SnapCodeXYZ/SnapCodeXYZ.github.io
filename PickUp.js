...
function one_click_fade(){
	if ( click_fin == 0 ){
		setTimeout(function(){fadeInOut_click()},0);
		setTimeout(function(){one_click_fade()},700);
	}
}
function fadeInOut_click()
{
	$(".click_pic").fadeOut(300) ;
	$(".click_pic").fadeIn(300) ;
}
...
function q1_img_move2(){
	...
	setTimeout(function(){one_click_fade();},1500);
}
